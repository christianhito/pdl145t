...
$(document).ready(function () {
    var options = {
        ...
        colors: ['#1c478b ', '#6f6593', '#8075aa', '#a192d9'],
        series: [44, 55, 41, 17],
        responsive: [{
            breakpoint: 480,
            options: {
...
$(document).ready(function () {
    var options = {
        ...
        colors: ['#1c478b ', '#e4bd51', '#e8769f', '#6c7989'],
        plotOptions: {
            radialBar: {
                dataLabels: {
                    name: {
